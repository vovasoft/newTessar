...
public class NewAdd {
    ...
    public NewAdd(int id, Date dateID, String mainId, String cID, String gID, String enter, long newAddNum, long activeNum, long loginCount, float averageLogin, long allPlayerNum, String other1, String other2, String other3, String other4) {
