...
public class StayMon extends StayParent {
    ...
    public StayMon(int id, Date dateID, String mainId, String cID, String gID, String enter, long newAddNum, String stayList, String other1, String other2, String other3, String other4) {
